...
import { getChatHistory, getToken, getUserData, storeChatHistory } from '../components/Storage';
...
const AdminChatScreen = ({ route, navigation }) => {
  ...
  const fetchChatHistory = async () => {
    try {
      const storedMessages = await getChatHistory(user._id)
      if(storedMessages){
      ...
      storeChatHistory(user._id, messagesWithReadStatus)
      console.log('====================================');
      console.log("messagesWithReadStatus");
      console.log('====================================');
